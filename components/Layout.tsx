...
import {Menu, X, Droplets, Instagram, Facebook, Linkedin, Youtube, User, Heart} from 'lucide-react';
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <Droplets size={24} />
                                ...
                                <div className="flex flex-col">
                                    <span
                                        className={`font-bold text-xl tracking-tight leading-none transition-colors ${
                                            isTransparent
                        ...
                        <div className="hidden md:flex items-center gap-4">
                            <Link
                                ...
                                target="_blank"
                                className="px-6 py-2.5 flex items-center justify-center gap-2 group bg-brand-green text-white text-sm font-bold rounded-full shadow-md hover:bg-green-700 hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <Droplets size={24} />
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-xs text-blue-200 font-medium tracking-wider">
                                        RIVER & OCEAN CLEANING
                                    </span>
                                </div>
                            </Link>
                            ...
                            <p className="text-slate-300 max-w-md mb-6">
                                Restoring the natural purity of South Africa's rivers and wetlands through impactful
                                clean-up initiatives, community engagement, and sustainable practices.
                            </p>
                            <div className="flex space-x-4">
                                <a href="https://instagram.com/hlanzekile.za" target="_blank" className="text-slate-300 hover:text-brand-yellow transition">
                                    <Instagram size={20} />
                                </a>
                                <a href="https://facebook.com/hlanzekile.org" target="_blank" className="text-slate-300 hover:text-brand-yellow transition">
                                    <Facebook size={20} />
                                </a>
                                <a href="https://za.linkedin.com/company/hlanzekile-river-and-ocean-cleaning" target="_blank" className="text-slate-300 hover:text-brand-yellow transition">
                                    <Linkedin size={20} />
                                </a>
                                <a href="https://www.youtube.com/%40Hlanzekile_org" target="_blank" className="text-slate-300 hover:text-brand-yellow transition">
                                    <Youtube size={20} />
                                </a>
                            </div>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-2 text-slate-300">
                                ...
                                <li>
                                    <Link to="/impact-stories" className="hover:text-white">
