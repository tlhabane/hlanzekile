    ...
    return (
        <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-white">
            <div className="relative w-24 h-24">
                ...
                {/* Spinning Arc 2 */}
                <div
                    className="absolute top-4 left-4 w-16 h-16 border-4 border-brand-green rounded-full border-b-transparent animate-spin"
            ...
            <div className="mt-8 flex">
                <div className="flex flex-col items-center justify-center">
                    <span className="font-heading text-3xl tracking-[0.2em] text-slate-800 font-bold animate-pulse">
                        HLANZEKILE
                    </span>
                    <span className="font-heading text-sm tracking-[0.2em] text-slate-800 font-bold animate-pulse">
