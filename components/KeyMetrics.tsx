    ...
    >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-slate-100">
            <div className="p-6">
                ...
                <div className="text-sm uppercase tracking-widest text-slate-500 font-semibold">Kgs Waste Collected</div>
            </div>
            <div className="p-6">
                <div className="text-5xl font-black text-brand-blue mb-2 tabular-nums">
                    {avgCount.toLocaleString()}
                </div>
                <div className="text-sm uppercase tracking-widest text-slate-500 font-semibold">Avg Kgs Per Clean</div>
            </div>
            <div className="p-6">
                <div className="text-5xl font-black text-brand-yellow mb-2 tabular-nums">
                    {riversCount}
                </div>
