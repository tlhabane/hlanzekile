        ...
        <div className="animate-fade-in">
            ...
            <section className="max-w-4xl mx-auto px-4 text-center mb-24">
                ...
                <p className="text-lg text-slate-600 leading-relaxed mb-8">
                    Hlanzekile is a movement born from the need to restore the Braamfontein Spruit. What started as a
                    small team has grown into a community-driven initiative that not only cleans rivers but empowers the
                    youth of Soweto through upcycling and education.
                </p>
                <Link
                    to="/about"
            ...
            <section className="py-24 bg-slate-50">
                <div className="max-w-7xl mx-auto px-24 sm:px-6 lg:px-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {VISION_DATA.map((vision) => (
                            <VisionCard
                                ...
                                icon={vision.icon as 'trash' | 'recycle'}
                                color={vision.color}
                            />
                        ))}
                    </div>
            ...
            <section className="bg-brand-blue py-20 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
                    ...
                    <p className="text-xl text-blue-100 mb-10">
                        Whether you donate, volunteer, or sponsor a grid, your contribution directly restores our rivers
                        and empowers communities.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Link
                            to="/volunteer"
                            className="px-8 py-4 bg-brand-green text-white font-bold rounded-full hover:bg-green-600 transition shadow-lg transform hover:-translate-y-1"
                        >
                            Get Involved Today
                        </Link>
                        <Link
                            to="/contact"
                            className="px-8 py-4 bg-transparent border-2 border-white text-white font-bold rounded-full hover:bg-white hover:text-brand-blue transition"
                        >
                            Contact Us
                        </Link>
                    </div>
