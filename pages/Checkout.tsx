        ...
        return (
            <div className="min-h-screen bg-white flex items-center justify-center p-4 animate-fade-in">
                <div className="max-w-xl w-full text-center space-y-8 p-12 bg-slate-50 rounded-[3rem] border border-slate-100 shadow-2xl">
                    ...
                    <div className="bg-white p-8 rounded-3xl border border-slate-100">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="text-xs font-bold text-slate-800">
                                #HLZ-{Math.random().toString(36).substr(2, 9).toUpperCase()}
                            </span>
                        </div>
                    ...
                    <Link
                        to="/portal"
                        className="w-full py-4 bg-brand-blue text-white rounded-2xl font-black block uppercase tracking-widest text-xs hover:bg-slate-900 transition shadow-lg"
                    >
                        Enter Member Portal
                    </Link>
                </div>
        ...
        <div className="min-h-screen bg-slate-50 pb-24">
            ...
            <section className="relative py-24 text-white text-center">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 text-center h-full flex flex-col justify-center items-center">
                    ...
                    <p className="text-blue-100 text-xl md:text-2xl max-w-6xl mx-auto leading-relaxed font-light opacity-90">
                        Thank you for helping us transform waste into opportunities.
                    </p>
                </div>
            </section>
            <div className="max-w-7xl mx-auto px-4 pt-24 grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                    <Link
                        to="/get-involved"
                        className="inline-flex items-center text-slate-400 hover:text-brand-blue gap-2 text-xs font-black uppercase tracking-widest"
                    >
                            ...
                            <div className="bg-white p-10 rounded-[2.5rem] shadow-xl border-4 border-brand-yellow/20 space-y-8 relative overflow-hidden">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600 text-sm font-light">
                                        Select a predefined amount or insert a custom value below.
                                    </p>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <span className="absolute left-4 top-1/2 -translate-y-1/2 font-black text-brand-blue">
                                            R
                                        </span>
                                        <input
                                            type="number"
                ...
                <div className="space-y-8">
                    <div className="bg-brand-blue rounded-[3rem] p-12 text-white shadow-2xl sticky top-32">
                        <div className="flex items-center gap-3 mb-10">
                            {donationType ? (
                                <Heart size={24} className="text-brand-yellow" />
                            ) : (
                            ...
                            {donationType ? (
                                <div className="flex justify-between items-start pb-6">
                                    <div>
                                        ...
                                        <p className="text-[10px] font-black text-blue-300 uppercase tracking-widest mb-2">
                                            Restoration Fund
                                        </p>
                                ...
                                cart.map((item) => (
                                    <div
                                        key={item.id}
                                        className="flex justify-between items-start pb-6 border-b border-white/10 last:border-0"
                                    >
                                        <div>
                                            <h4 className="font-bold text-lg leading-none mb-2">
                                                {item.gridNumber ? `Grid #${item.gridNumber}` : item.areaName}
                                            </h4>
                                            <p className="text-[10px] font-black text-blue-300 uppercase tracking-widest mb-2">
                                                {item.areaName}
                                            </p>
                                            <span className="text-[10px] font-black bg-brand-green/20 text-brand-green px-2 py-1 rounded-md uppercase tracking-widest">
                                                {item.plan}
                                            </span>
                                        </div>
