            ...
            <section className="bg-brand-blue pt-32 pb-16 text-white">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    ...
                    <p className="text-blue-100 max-w-2xl mx-auto">
                        Hlanzekile invites you to be a pivotal part of our mission. Your support can take various forms,
                        from monetary contributions to active volunteering.
                    </p>
                </div>
            </section>
                                ...
                                <form onSubmit={handleDonateSubmit} className="space-y-6 max-w-lg mx-auto">
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                type="number"
                                                className="w-full pl-8 pr-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-green focus:border-transparent outline-none"
                                                placeholder={donationType === 'grid' ? '500' : 'Enter amount'}
                                                defaultValue={donationType === 'grid' ? 500 : ''}
                                                readOnly={donationType === 'grid'}
                                            />
                                        </div>
                                        {donationType === 'grid' && (
                                            <p className="text-xs text-brand-green mt-1">
                                                Fixed price to clean 5 square meters.
                                            </p>
                                        )}
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                type="text"
                                                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-green outline-none"
                                                required
                                            />
                                        </div>
                                        <div>
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full bg-brand-green text-white font-bold py-4 rounded-lg hover:bg-green-700 transition flex items-center justify-center gap-2"
                                    >
                                        <CreditCard size={20} /> Proceed to Payment
                                    </button>
                                    <p className="text-center text-xs text-slate-500 mt-4">
                                        Secured by PayFast / Stripe
                                    </p>
                                </form>
                            </div>
                        ) : (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                    <div>
                                        ...
                                        <p className="text-slate-600 mb-6">
                                            We welcome everyone to join us. We want everyone to learn about taking care
                                            of our rivers and the environment.
                                        </p>
                                        <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
                                            ...
                                            <p className="text-sm text-slate-600 mb-4">
                                                Saturday, 15 June 2025 • 08:00 AM
                                            </p>
                                            <button className="bg-brand-blue text-white px-6 py-2 rounded-lg text-sm font-bold hover:bg-blue-900 transition">
                                                RSVP Now
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <form className="space-y-4">
                                            <input
                                                ...
                                                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-blue outline-none"
                                            />
                                            <input
                                                type="email"
