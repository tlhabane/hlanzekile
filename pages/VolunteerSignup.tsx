...
export const VolunteerSignup: React.FC = () => {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50 pt-20 px-4">
                <div className="max-w-xl w-full text-center space-y-8 p-12 bg-white rounded-[3rem] shadow-2xl border border-slate-100 animate-fade-in">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-brand-blue uppercase tracking-tighter mb-4">You're Enlisted!</h1>
    ...
    return (
        <div className="animate-fade-in bg-slate-50 min-h-screen relative flex flex-col items-center">
            {/* Hero Header Section */}
            {/*<div className="absolute top-0 left-0 w-full h-[60vh] min-h-[500px] overflow-hidden z-0">
                <img
                    src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?q=80&w=2000&auto=format&fit=crop"
                    alt="Become a Steward of Change | Hlanzekile River & Ocean Cleaning"
                    className="w-full h-full object-cover grayscale-[20%]"
                />
                <div className="absolute inset-0 bg-brand-blue/80 mix-blend-multiply"></div>
                <div className="absolute inset-0 bg-gradient-to-b from-brand-blue/40 to-transparent"></div>
            </div>*/}
            {/* Hero Header */}
