...
import { ImpactStoryList } from './pages/ImpactStoryList';
        ...
        <>
            ...
            <Layout>
                <Routes>
                    ...
                    <Route path="/impact/story/:slug" element={<ImpactStoryDetail />} />
                    <Route path="/impact-stories" element={<ImpactStoryList />} />
                    ...
                    <Route path="/letter-from-our-director" element={<DirectorLetter />} />
                </Routes>
            </Layout>
