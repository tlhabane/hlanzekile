...
import { ChevronRight, Droplets, MapPin, Zap, ShoppingCart, X, Plus, Minus, Trash2, ShieldCheck } from 'lucide-react';
        ...
        <div className="animate-fade-in bg-white min-h-screen">
            ...
            <section className="max-w-7xl mx-auto px-4 py-24 relative">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-extrabold text-brand-blue mb-6 tracking-tight">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    {MOCK_AREAS.map((area) => {
                        ...
                        return (
                            <div
                                key={area.id}
                                className="group bg-slate-50 rounded-[2.5rem] overflow-hidden shadow-sm border border-slate-100 flex flex-col h-full"
                            >
                                ...
                                <div className="p-8 lg:p-12 flex flex-col flex-grow">
                                    <div className="mb-8">
                                        <h3 className="text-3xl font-black text-brand-blue tracking-tighter mb-2">
                                            {area.fullName}
                                        </h3>
                                            ...
                                            <div className="flex items-center justify-between gap-6">
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <span className="text-2xl font-black text-brand-blue">
                                                        R{' '}
                                                        {(selection.plan === 'monthly' ? 500 : 5000) *
                                                            selection.quantity}
                                                    </span>
                                                </div>
                                            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-16">
                    <div className="text-center">
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed">
                            Your funds go directly to the cleanup crews operating in your chosen area within 48 hours.
                        </p>
                    </div>
                    <div className="text-center">
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed">
                            Receive a detailed audit of the waste collected from the grids you support.
                        </p>
                    </div>
                    <div className="text-center">
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed">
                            Exclusive access to photos and logs for your sponsored segments via the Portal.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="relative ml-auto w-full max-w-md bg-white h-full shadow-2xl flex flex-col animate-slide-left">
                        ...
                        <div className="p-8 flex-grow overflow-y-auto space-y-6">
                            {cart.map((item) => (
                                <div
                                    key={item.id}
                                    className="p-6 bg-slate-50 rounded-3xl border border-slate-100 flex justify-between items-center group relative overflow-hidden"
                                >
                                    <div className="absolute top-0 left-0 w-1 h-full bg-brand-green"></div>
                                    <div className="flex-grow">
                                        <h4 className="font-black text-brand-blue text-sm uppercase leading-none mb-2">
                                            {item.areaName}
                                        </h4>
                                        <div className="flex items-center gap-2 mb-3">
                                            <span
                                                className={`text-[10px] font-black px-2 py-0.5 rounded-md uppercase tracking-widest ${item.plan === 'monthly' ? 'bg-brand-green/10 text-brand-green' : 'bg-brand-yellow/10 text-brand-yellow'}`}
                                            >
                                                {item.plan}
                                            </span>
                            ...
                            {cart.length === 0 && (
                                <div className="text-center py-24 text-slate-400">
                                    ...
                                    <button
                                        onClick={() => setIsCartOpen(false)}
                                        className="mt-6 text-brand-blue font-bold text-sm underline"
                                    >
                                        Start Sponsoring
                                    </button>
                                </div>
            ...
            {!isCartOpen && cart.length > 0 && (
                ...
                >
                    ...
                    <span className="font-black uppercase tracking-widest text-xs pr-2 border-l border-white/20 pl-4">
                        Basket Total: R {total}
                    </span>
                </button>
            )}
        </div>
