            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
                    ...
                    <p className="text-blue-100 text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed font-light opacity-90">
                        Adopt a 5m x 5m segment of our vital riverbanks. Your sponsorship funds the cleaning, brand
                        auditing, and ecological maintenance of your specific grid for a full year.
                    </p>
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-4 py-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    {MOCK_AREAS.map((area) => (
                        <div
                            key={area.id}
                            className="group bg-slate-50 rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-slate-100 flex flex-col h-full"
                        >
                            ...
                            <div className="p-12 flex flex-col flex-grow">
                                <div className="mb-8">
                                    ...
                                    <p className="text-sm font-bold text-brand-green uppercase tracking-wider mb-4">
                                        {area.name} District
                                    </p>
                                    <p className="text-slate-600 font-light leading-relaxed">{area.description}</p>
                                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-16">
                    <div className="text-center">
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed">
                            Your funds go directly to the cleanup crews operating in your specific grid within 48 hours.
                        </p>
                    </div>
                    <div className="text-center">
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed">
                            Receive a detailed audit of the waste collected from your grid, including brand statistics.
                        </p>
                    </div>
                    <div className="text-center">
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed">
                            Access your grid's "Digital Twin" in the member portal to see photos and cleanup logs
                            anytime.
                        </p>
                    </div>
                </div>
