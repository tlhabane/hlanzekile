...
import { ChevronDown, ArrowRight, Maximize2 } from 'lucide-react';
import { Link } from 'react-router-dom';
import { KeyMetrics } from '../components/KeyMetrics';
import { ImpactStoriesCarousel } from '../components/ImpactStoriesCarousel';
import { Lightbox } from '../components/Lightbox';
import { UpcyclingMedia as GALLERY_MEDIA } from '@/services';
import { Headers } from '@/assets/headers';

const HeaderImage = Headers.whatWeDo;

export const WhatWeDo: React.FC = () => {
    window.document.title = 'What We Do :: Hlanzekile River & Ocean Cleaning';
        ...
        <div className="animate-fade-in">
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <img
                        src={HeaderImage.url}
                        alt="What We Do | Hlanzekile River & Ocean Cleaning"
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 text-center h-full flex flex-col justify-center items-center pt-20">
                    ...
                    <p className="text-blue-100 text-xl md:text-2xl max-w-6xl mx-auto leading-relaxed font-light mb-12 opacity-90">
                        To restore the natural purity of South Africa's rivers and wetlands through impactful clean-up
                        initiatives, community engagement, and sustainable practices, we follow a systematic approach to
                        environmental stewardship, ensuring every piece of litter is accounted for and responsibly
                        managed.
                    </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-16">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-brand-green font-bold tracking-widest uppercase text-xs">
                                4 Simple Steps
                            </span>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {steps.map((step) => (
                            <div
                                key={step.num}
                                className="bg-white/5 rounded-2xl p-8 flex flex-col min-h-[300px] hover:bg-white/10 transition-colors duration-300 border border-white/10 group backdrop-blur-sm"
                            >
                                ...
                                <div className="min-h-[125px]">
                                    ...
                                    <h3 className="text-2xl font-bold text-white leading-tight group-hover:text-brand-green transition-colors">
                                        {step.title}
                                    </h3>
                                </div>
                                <div>
                    ...
                    <div className="mt-8 bg-white/5 rounded-2xl p-4 md:px-8 md:py-6 flex flex-col md:flex-row items-center justify-between gap-6 border border-white/10 shadow-xl backdrop-blur-sm">
                        <div className="flex items-center gap-4 w-full md:w-auto">
                            <div className="flex -space-x-3 flex-shrink-0">
                                <img
                                    src="https://picsum.photos/seed/v1/100/100"
                                    className="w-10 h-10 rounded-full border-2 border-brand-blue object-cover"
                                    alt="Volunteer"
                                />
                                <img
                                    src="https://picsum.photos/seed/v2/100/100"
                                    className="w-10 h-10 rounded-full border-2 border-brand-blue object-cover"
                                    alt="Volunteer"
                                />
                                <img
                                    src="https://picsum.photos/seed/v3/100/100"
                                    className="w-10 h-10 rounded-full border-2 border-brand-blue object-cover"
                                    alt="Volunteer"
                                />
                                <div className="w-10 h-10 rounded-full border-2 border-brand-blue bg-brand-green flex items-center justify-center text-xs text-white font-bold">
                                    +100
                                </div>
                            </div>
                            <p className="text-white font-medium text-sm md:text-base">
                                Align with a community that chooses <span className="text-white font-bold">Action</span>
                            </p>
                        </div>

                        <Link
                            to="/volunteer"
                            className="bg-white text-[#0B1120] px-8 py-3 rounded-full font-bold hover:bg-brand-green hover:text-white transition-all flex items-center justify-center gap-2 group w-full md:w-auto whitespace-nowrap"
                        >
                            Start Now{' '}
                ...
                <div className=" py-24 px-4 text-center">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <p className="text-slate-600 text-lg leading-relaxed">
                            We have started an upcycling workshop in the heart of Soweto, Orlando West. This initiative
                            was made possible through a generous donation of workshop space.
                        </p>
                    </div>
                </div>
                        ...
                        {GALLERY_MEDIA.map((img, idx) => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-brand-blue/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center text-brand-blue shadow-2xl transform scale-50 group-hover:scale-100 transition-transform">
                                        <Maximize2 size={32} />
                                    </div>
                                </div>
                            </div>
            ...
            <section className="bg-brand-blue py-20 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
                    ...
                    <p className="text-xl text-blue-100 mb-10 leading-relaxed">
                        Your support enables us to continue these critical cleaning and upcycling operations. Join us in
                        making a tangible difference for our rivers and communities.
                    </p>
