...
const GridBlock: React.FC<GridBlockProps> = ({
    ...
    return (
        <div
            className={`aspect-square w-full flex flex-col items-center justify-center p-8 text-center transition-colors duration-300 ${dark ? 'bg-[#121212] text-white' : 'bg-brand-blue text-white'}`}
        >
            <h3 className="text-2xl font-black mb-4 tracking-tighter leading-none">{title}</h3>
            ...
            {price && <p className="text-slate-300 text-xs mt-4 tracking-widest opacity-80">Starting from {price}</p>}
        </div>
    );
};
        ...
        <div className="animate-fade-in bg-white">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div>
                            ...
                            <p className="text-slate-600 text-lg leading-relaxed mb-10 max-w-xl font-light">
                                Since 2023, we have proved that localized action creates regional restoration. Our
                                data-driven approach ensures that every Rand and every hour spent on the riverbank is
                                accounted for.{' '}
                                <span className="font-bold text-brand-blue">But we need more hands.</span>
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-6">
                                ...
                                <Link
                                    to="/impact-dashboard"
                                    className="inline-flex items-center gap-3 py-4 px-8 bg-brand-blue text-white font-bold rounded-2xl hover:bg-slate-900 transition shadow-lg group"
                                >
                        ...
                        <div className="grid grid-cols-2 gap-4 md:gap-8">
                            <div className="bg-white p-10 rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center text-center group hover:border-brand-blue/30 transition-colors">
                                <Waves
                                    size={32}
                                    className="text-brand-blue mb-6 group-hover:scale-110 transition-transform"
                                />
                            ...
                            <div className="bg-white p-10 rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center text-center group hover:border-brand-green/30 transition-colors">
                                <Users
                                    size={32}
                                    className="text-brand-green mb-6 group-hover:scale-110 transition-transform"
                                />
                            ...
                            <div className="bg-white p-10 rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center text-center group hover:border-brand-yellow/30 transition-colors">
                                <Recycle
                                    size={32}
                                    className="text-brand-yellow mb-6 group-hover:scale-110 transition-transform"
                                />
            ...
            <section className="bg-white py-24 px-4 text-center">
                <div className="max-w-3xl mx-auto">
                    <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tighter leading-none">
                        Choose your <span className="text-brand-green">Path</span> <br /> to{' '}
                        <span className="text-brand-green">Action</span>
                    </h2>
                    <p className="text-slate-500 text-lg max-w-2xl mx-auto font-light leading-relaxed mb-4">
                        Every contribution is directly applied to our active field operations. Select a stewardship path
                        that fits your commitment level.
                    </p>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 border-t border-slate-100">
                {/* Row 1 */}
                <GridBlock type="image" imageUrl="https://placehold.co/1024x1024/webp" />
                <GridBlock
                    type="text"
            ...
            <section className="bg-white py-32 px-4 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tighter leading-none">
                        Radical <span className="text-brand-green">Transparency</span>
                    </h2>
                    <p className="text-slate-400 mb-12 text-xl leading-relaxed">
                        We believe you should see exactly where your support goes. Our Live Impact Dashboard tracks
                        every bag of waste, every volunteer hour, and every square meter restored in real-time.
                    </p>
                    <Link
                        to="/impact-dashboard"
